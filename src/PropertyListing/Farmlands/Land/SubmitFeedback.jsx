...
const SubmitFeedback = () => {
    return (
        <>
            <div className='border-t border-[#F2F4F7] px-20 w-screen'>

                <div className="mt-6 mb-16 px-7 ">
                    ...
                    <div className="right w-1/2">
                        {/* <form action="">
                            <div className="name mb-3">
                                <label className='text-[#344054]'>Full Name</label>
                                <input
                                    type="text"
                                    placeholder='Full Name'
                                    className='border-2 border-[#C6D2E0] block w-[70%] rounded-lg p-2 mt-1.5'
                                />
                            </div>
                            ...
                            <div className="mobile mb-3">
                                <label className='text-[#344054]'>Mobile Number</label>
                                <input
                                    type="number"
                            ...
                            <div className="gender">
                                <label className='text-[#344054] block'>Gender</label>
                                <div className="gender-radio flex">
                                    <input type="radio" /> <span>Male</span>
                                    <input type="radio" /> <span>Female</span>
                                    <input type="radio" /> <span>Others</span>
                                </div>
                            </div>
                        </form> */}
                        ...
                        <form action="">
                            <div className="space-y-4">
                                <div>
                                    ...
                                    <input type="text" id="fullName" placeholder="Full Name" className="w-4/5 p-2 border border-[#C6D2E0] rounded-md" />
                                </div>
                                <div>
                            ...
                            <button type="submit" className="bg-black text-white py-2 px-4 rounded-md hover:bg-[#054b10] transition duration-300">
                                Submit
                            </button>
                        </form>
                    </div>
